...
Setlist.create( date: DateTime.now + 1, name: "Set 1")
Setlist.create( date: DateTime.now + 2, name: "Set 2")
Setlist.create( date: DateTime.now + 3, name: "Set 3")
Setlist.create( date: DateTime.now + 4, name: "Set 4")
Setlist.create( date: DateTime.now + 5, name: "Set 5")
Setlist.create( date: DateTime.now + 6, name: "Set 6")
Setlist.create( date: DateTime.now + 7, name: "Set 7")
Setlist.create( date: DateTime.now + 8, name: "Set 8")
Setlist.create( date: DateTime.now + 9, name: "Set 9")
Setlist.create( date: DateTime.now + 10, name: "Set 10")
